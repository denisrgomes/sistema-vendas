...
import com.denis.rainer.sistema.venda.VendaDAOHibernate;
...
public class DAOFactory {
	...
	public static ClienteDAO criarClienteDAO() {
		...
		clienteDAOHibernate.setSession(HibernateUtil.getSession()
				.getCurrentSession());
	...
	public static ProdutoDAO criarProdutoDAO() {
		...
		produtoDAOHibernate.setSession(HibernateUtil.getSession()
				.getCurrentSession());
	...
	public static VendaDAO criarVendaDAO() {
		...
		vendaDAOHibernate.setSession(HibernateUtil.getSession()
				.getCurrentSession());
